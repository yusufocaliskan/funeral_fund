...
<h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Kayıt İşleminiz Tamamlandı</strong></h1>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0; mso-line-height-alt: 30.6px;"><span style="font-size:17px;">Sayın {{user_name}}, kayıt işleminiz tamamladık. En kısa zaman size dönüş yapılacaklartır. Sabrınız için teşekürler.</span></p>
<p style="margin: 0; mso-line-height-alt: 21.6px;"> </p>
</div>
</div>
</td>
